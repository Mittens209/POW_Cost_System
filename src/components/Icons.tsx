...
export const ConstructionIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M3 12h18M12 3v18M8 8l8 8M8 16l8-8"/>
...
export const HeroIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 200 120" fill="none">
    <rect width="200" height="120" fill="hsl(224, 76%, 48%)" opacity="0.1"/>
    <g transform="translate(20, 20)">
      {/* Building blocks representing construction */}
      <rect x="0" y="60" width="40" height="40" fill="hsl(224, 76%, 48%)" opacity="0.8"/>
      <rect x="50" y="40" width="40" height="60" fill="hsl(224, 76%, 48%)" opacity="0.6"/>
      <rect x="100" y="20" width="40" height="80" fill="hsl(224, 76%, 48%)" opacity="0.7"/>
      <rect x="150" y="50" width="30" height="50" fill="hsl(224, 76%, 48%)" opacity="0.5"/>
      
      {/* Grid lines representing planning */}
      <g stroke="hsl(224, 76%, 48%)" strokeWidth="1" opacity="0.3">
